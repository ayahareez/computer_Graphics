...
namespace graphics_package
{
    public partial class Form1 : Form
    {
...

        {
            ...
            double xIncrement, yIncrement, x = xInitial, y = yInitial;
            string ys, xs;
            ...
            string filePath = @"D:\needs\Computer-Graphics-Algorithms\graphics package\graphics package\XMLFile1.html";
            ...
            for (k = 0; k < steps; k++)
            {
                ...
                xs = xf.ToString();
                ys = yf.ToString();
                //File.WriteAllLines(filePath, yf.ToString());
    ...
    private void label4_Click(object sender, EventArgs e)
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            textBox28.Clear();
            panel1.Refresh();
            panel1.CreateGraphics().Clear(Color.DarkCyan);
        }
